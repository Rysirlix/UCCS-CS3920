      ...
      <div style="margin-top:10px;">
        <a href="/report.json" download
           style="display:inline-block;padding:8px 16px;border-radius:6px;
                  background:#5DADE2;color:#000;text-decoration:none;
                  font-weight:bold;">
          ⬇ Download JSON Risk Report
        </a>
      </div>
    </div>
    """
      ...
      <div style='overflow-x:auto;'>
        <table>
          <tr>
            ...
            <th>Detect</th><th>Time</th><th>E[L]</th><th>Techniques</th><th>Actions</th>
          </tr>
    """
